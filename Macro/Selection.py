...
class Alpha_Factor(Selection):
   #Alpha Factor Class selection (current choices available are: Momentum)
   class Momentum:
      # Alpha Factor: Momentum
      def __init__(self, minimum_momentum, number_of_stocks, exclude_days):
         self.minimum_momentum = minimum_momentum
